...
class SetCustomVerification(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["bot", "custom_description", "enabled", "peer"]
    ...
    def read(b: BytesIO, *args: Any) -> "SetCustomVerification":
        ...
        return SetCustomVerification(
            peer=peer, enabled=enabled, bot=bot, custom_description=custom_description,
        )
