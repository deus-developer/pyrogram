...
class GetBroadcastRevenueTransactions(
    TLFunction["raw.base.stats.BroadcastRevenueTransactions"],
):  # type: ignore
    ...
    __slots__: list[str] = ["channel", "limit", "offset"]
    ...
    def read(b: BytesIO, *args: Any) -> "GetBroadcastRevenueTransactions":
        ...
        return GetBroadcastRevenueTransactions(
            channel=channel,
            offset=offset,
            limit=limit,
        )
