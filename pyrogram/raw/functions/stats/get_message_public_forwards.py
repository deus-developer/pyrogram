...
class GetMessagePublicForwards(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["channel", "limit", "msg_id", "offset"]

    ID = 0x5F150144
    QUALNAME = "functions.stats.GetMessagePublicForwards"

    def __init__(
        self, *, channel: "raw.base.InputChannel", msg_id: int, offset: str, limit: int,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "GetMessagePublicForwards":
        ...
        return GetMessagePublicForwards(
            channel=channel, msg_id=msg_id, offset=offset, limit=limit,
        )
