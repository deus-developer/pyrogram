...
class GetChannelDifference(TLFunction["raw.base.updates.ChannelDifference"]):  # type: ignore
    ...
    __slots__: list[str] = ["channel", "filter", "force", "limit", "pts"]
    ...
    def __init__(
        ...
        *,
        ...
        filter: "raw.base.ChannelMessagesFilter",
        pts: int,
        limit: int,
