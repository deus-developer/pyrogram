...
class EditExportedInvite(TLFunction["raw.base.ExportedChatlistInvite"]):  # type: ignore
    ...
    __slots__: list[str] = ["chatlist", "peers", "slug", "title"]
    ...
    def __init__(
        ...
        *,
        ...
        slug: str,
        title: str | None = None,
        peers: list["raw.base.InputPeer"] | None = None,
    ) -> None:
