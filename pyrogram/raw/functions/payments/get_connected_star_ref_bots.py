...
class GetConnectedStarRefBots(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["limit", "offset_date", "offset_link", "peer"]
    ...
    def read(b: BytesIO, *args: Any) -> "GetConnectedStarRefBots":
        ...
        return GetConnectedStarRefBots(
            peer=peer, limit=limit, offset_date=offset_date, offset_link=offset_link,
        )
