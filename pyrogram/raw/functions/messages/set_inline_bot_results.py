...
class SetInlineBotResults(TLFunction[bool]):  # type: ignore
    ...
    def __init__(
        ...
        *,
        query_id: int,
        results: list["raw.base.InputBotInlineResult"],
        cache_time: int,
        gallery: bool | None = None,
        private: bool | None = None,
        next_offset: str | None = None,
        switch_pm: "raw.base.InlineBotSwitchPM" = None,
        switch_webview: "raw.base.InlineBotWebView" = None,
    ) -> None:
