...
class SendPaidReaction(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["count", "msg_id", "peer", "private", "random_id"]
    ...
    def __init__(
        ...
        *,
        ...
        count: int,
        random_id: int,
        private: "raw.base.PaidReactionPrivacy" = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SendPaidReaction":
        ...
        return SendPaidReaction(
            peer=peer, msg_id=msg_id, count=count, random_id=random_id, private=private,
        )
