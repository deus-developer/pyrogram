...
class DeleteSavedHistory(TLFunction["raw.base.messages.AffectedHistory"]):  # type: ignore
    ...
    __slots__: list[str] = ["max_date", "max_id", "min_date", "peer"]
