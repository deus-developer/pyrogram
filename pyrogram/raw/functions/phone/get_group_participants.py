...
class GetGroupParticipants(TLFunction["raw.base.phone.GroupParticipants"]):  # type: ignore
    ...
    __slots__: list[str] = ["call", "ids", "limit", "offset", "sources"]
