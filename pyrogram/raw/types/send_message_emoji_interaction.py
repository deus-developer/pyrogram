...
class SendMessageEmojiInteraction(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["emoticon", "interaction", "msg_id"]

    ID = 0x25972BCB
    QUALNAME = "types.SendMessageEmojiInteraction"

    def __init__(
        self, *, emoticon: str, msg_id: int, interaction: "raw.base.DataJSON",
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SendMessageEmojiInteraction":
        ...
        return SendMessageEmojiInteraction(
            emoticon=emoticon, msg_id=msg_id, interaction=interaction,
        )
