...
class BotInfo(TLObject):  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        description_photo: "raw.base.Photo" = None,
        description_document: "raw.base.Document" = None,
        commands: list["raw.base.BotCommand"] | None = None,
        menu_button: "raw.base.BotMenuButton" = None,
        privacy_policy_url: str | None = None,
        app_settings: "raw.base.BotAppSettings" = None,
        verifier_settings: "raw.base.BotVerifierSettings" = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "BotInfo":
        ...
        return BotInfo(
            has_preview_medias=has_preview_medias,
            user_id=user_id,
