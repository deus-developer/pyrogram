...
class InputStickerSetItem(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["document", "emoji", "keywords", "mask_coords"]
    ...
    def __init__(
        ...
        *,
        ...
        emoji: str,
        mask_coords: "raw.base.MaskCoords" = None,
    ...
    def read(b: BytesIO, *args: Any) -> "InputStickerSetItem":
        ...
        return InputStickerSetItem(
            document=document, emoji=emoji, mask_coords=mask_coords, keywords=keywords,
        )
