...
class MessageActionGiveawayResults(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["stars", "unclaimed_count", "winners_count"]

    ID = 0x87E2F155
    QUALNAME = "types.MessageActionGiveawayResults"

    def __init__(
        self, *, winners_count: int, unclaimed_count: int, stars: bool | None = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionGiveawayResults":
        ...
        return MessageActionGiveawayResults(
            winners_count=winners_count, unclaimed_count=unclaimed_count, stars=stars,
        )
