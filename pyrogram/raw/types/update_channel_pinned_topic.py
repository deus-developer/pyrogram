...
class UpdateChannelPinnedTopic(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["channel_id", "pinned", "topic_id"]

    ID = 0x192EFBE3
    QUALNAME = "types.UpdateChannelPinnedTopic"

    def __init__(
        self, *, channel_id: int, topic_id: int, pinned: bool | None = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateChannelPinnedTopic":
        ...
        return UpdateChannelPinnedTopic(
            channel_id=channel_id, topic_id=topic_id, pinned=pinned,
        )
