...
class UpdateChatParticipantAdmin(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["chat_id", "is_admin", "user_id", "version"]

    ID = 0xD7CA61A2
    QUALNAME = "types.UpdateChatParticipantAdmin"

    def __init__(
        self, *, chat_id: int, user_id: int, is_admin: bool, version: int,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateChatParticipantAdmin":
        ...
        return UpdateChatParticipantAdmin(
            chat_id=chat_id, user_id=user_id, is_admin=is_admin, version=version,
        )
