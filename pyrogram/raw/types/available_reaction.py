...
class AvailableReaction(TLObject):  # type: ignore
    ...
    def __init__(
        ...
        *,
        reaction: str,
        title: str,
        static_icon: "raw.base.Document",
        appear_animation: "raw.base.Document",
        select_animation: "raw.base.Document",
        activate_animation: "raw.base.Document",
        effect_animation: "raw.base.Document",
        inactive: bool | None = None,
        premium: bool | None = None,
        around_animation: "raw.base.Document" = None,
        center_icon: "raw.base.Document" = None,
    ) -> None:
