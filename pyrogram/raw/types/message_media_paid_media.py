...
class MessageMediaPaidMedia(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["extended_media", "stars_amount"]
    ...
    def __init__(
        ...
        *,
        stars_amount: int,
        extended_media: list["raw.base.MessageExtendedMedia"],
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageMediaPaidMedia":
        ...
        return MessageMediaPaidMedia(
            stars_amount=stars_amount, extended_media=extended_media,
        )
