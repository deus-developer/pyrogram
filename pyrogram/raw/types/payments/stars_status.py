...
class StarsStatus(TLObject):  # type: ignore
    ...
    def __init__(
        self,
        *,
        balance: "raw.base.StarsAmount",
        chats: list["raw.base.Chat"],
        users: list["raw.base.User"],
        subscriptions: list["raw.base.StarsSubscription"] | None = None,
        subscriptions_next_offset: str | None = None,
        subscriptions_missing_balance: int | None = None,
        history: list["raw.base.StarsTransaction"] | None = None,
        ...
        self.subscriptions_missing_balance = (
    ...
    def read(b: BytesIO, *args: Any) -> "StarsStatus":
        ...
        return StarsStatus(
            ...
            subscriptions_missing_balance=subscriptions_missing_balance,
            history=history,
