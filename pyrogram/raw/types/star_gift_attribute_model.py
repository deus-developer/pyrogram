...
class StarGiftAttributeModel(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["document", "name", "rarity_permille"]

    ID = 0x39D99013
    QUALNAME = "types.StarGiftAttributeModel"

    def __init__(
        self, *, name: str, document: "raw.base.Document", rarity_permille: int,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "StarGiftAttributeModel":
        ...
        return StarGiftAttributeModel(
            name=name, document=document, rarity_permille=rarity_permille,
        )
