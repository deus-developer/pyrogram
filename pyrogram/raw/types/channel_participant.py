...
class ChannelParticipant(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["date", "subscription_until_date", "user_id"]

    ID = 0xCB397619
    QUALNAME = "types.ChannelParticipant"

    def __init__(
        self, *, user_id: int, date: int, subscription_until_date: int | None = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelParticipant":
        ...
        return ChannelParticipant(
            user_id=user_id, date=date, subscription_until_date=subscription_until_date,
        )
