...
class InputStorePaymentStarsGift(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["amount", "currency", "stars", "user_id"]

    ID = 0x1D741EF7
    QUALNAME = "types.InputStorePaymentStarsGift"

    def __init__(
        self, *, user_id: "raw.base.InputUser", stars: int, currency: str, amount: int,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "InputStorePaymentStarsGift":
        ...
        return InputStorePaymentStarsGift(
            user_id=user_id, stars=stars, currency=currency, amount=amount,
        )
