...
class SavedPhoneContact(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["date", "first_name", "last_name", "phone"]

    ID = 0x1142BD56
    QUALNAME = "types.SavedPhoneContact"

    def __init__(
        self, *, phone: str, first_name: str, last_name: str, date: int,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SavedPhoneContact":
        ...
        return SavedPhoneContact(
            phone=phone, first_name=first_name, last_name=last_name, date=date,
        )
