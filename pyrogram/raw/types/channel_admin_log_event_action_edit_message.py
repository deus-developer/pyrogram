...
class ChannelAdminLogEventActionEditMessage(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["new_message", "prev_message"]

    ID = 0x709B2405
    QUALNAME = "types.ChannelAdminLogEventActionEditMessage"

    def __init__(
        self, *, prev_message: "raw.base.Message", new_message: "raw.base.Message",
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelAdminLogEventActionEditMessage":
        ...
        return ChannelAdminLogEventActionEditMessage(
            prev_message=prev_message, new_message=new_message,
        )
