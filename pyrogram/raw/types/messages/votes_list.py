...
class VotesList(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["chats", "count", "next_offset", "users", "votes"]
    ...
    def __init__(
        ...
        *,
        count: int,
        votes: list["raw.base.MessagePeerVote"],
    ...
    def read(b: BytesIO, *args: Any) -> "VotesList":
        ...
        return VotesList(
            count=count, votes=votes, chats=chats, users=users, next_offset=next_offset,
        )
