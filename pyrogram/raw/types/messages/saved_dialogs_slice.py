...
class SavedDialogsSlice(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["chats", "count", "dialogs", "messages", "users"]
    ...
    def __init__(
        ...
        *,
        count: int,
        dialogs: list["raw.base.SavedDialog"],
    ...
    def read(b: BytesIO, *args: Any) -> "SavedDialogsSlice":
        ...
        return SavedDialogsSlice(
            count=count, dialogs=dialogs, messages=messages, chats=chats, users=users,
        )
