...
class InputSecureValue(TLObject):  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        front_side: "raw.base.InputSecureFile" = None,
        reverse_side: "raw.base.InputSecureFile" = None,
        selfie: "raw.base.InputSecureFile" = None,
        translation: list["raw.base.InputSecureFile"] | None = None,
        files: list["raw.base.InputSecureFile"] | None = None,
