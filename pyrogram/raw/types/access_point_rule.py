...
class AccessPointRule(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["dc_id", "ips", "phone_prefix_rules"]

    ID = 0x4679B65F
    QUALNAME = "types.AccessPointRule"

    def __init__(
        self, *, phone_prefix_rules: str, dc_id: int, ips: list["raw.base.IpPort"],
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "AccessPointRule":
        ...
        return AccessPointRule(
            phone_prefix_rules=phone_prefix_rules, dc_id=dc_id, ips=ips,
        )
