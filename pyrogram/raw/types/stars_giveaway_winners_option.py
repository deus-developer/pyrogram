...
class StarsGiveawayWinnersOption(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["default", "per_user_stars", "users"]

    ID = 0x54236209
    QUALNAME = "types.StarsGiveawayWinnersOption"

    def __init__(
        self, *, users: int, per_user_stars: int, default: bool | None = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "StarsGiveawayWinnersOption":
        ...
        return StarsGiveawayWinnersOption(
            users=users, per_user_stars=per_user_stars, default=default,
        )
