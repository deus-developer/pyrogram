...
class StarGiftAttributeOriginalDetails(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["date", "message", "recipient_id", "sender_id"]
    ...
    def __init__(
        self,
        *,
        recipient_id: "raw.base.Peer",
        date: int,
        sender_id: "raw.base.Peer" = None,
    ...
    def read(b: BytesIO, *args: Any) -> "StarGiftAttributeOriginalDetails":
        ...
        return StarGiftAttributeOriginalDetails(
            recipient_id=recipient_id, date=date, sender_id=sender_id, message=message,
        )
