...
class ReactionsNotifySettings(TLObject):  # type: ignore
    ...
    def __init__(
        self,
        *,
        sound: "raw.base.NotificationSound",
        show_previews: bool,
        messages_notify_from: "raw.base.ReactionNotificationsFrom" = None,
        stories_notify_from: "raw.base.ReactionNotificationsFrom" = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ReactionsNotifySettings":
        ...
        return ReactionsNotifySettings(
            ...
            messages_notify_from=messages_notify_from,
            stories_notify_from=stories_notify_from,
        )
