...
class ChannelFull(TLObject):  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        unread_count: int,
        chat_photo: "raw.base.Photo",
        notify_settings: "raw.base.PeerNotifySettings",
        bot_info: list["raw.base.BotInfo"],
        pts: int,
        ...
        restricted_sponsored: bool | None = None,
        ...
        stargifts_available: bool | None = None,
        ...
        emojiset: "raw.base.StickerSet" = None,
