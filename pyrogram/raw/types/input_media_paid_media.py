...
class InputMediaPaidMedia(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["extended_media", "payload", "stars_amount"]
    ...
    def __init__(
        ...
        *,
        stars_amount: int,
        extended_media: list["raw.base.InputMedia"],
    ...
    def read(b: BytesIO, *args: Any) -> "InputMediaPaidMedia":
        ...
        return InputMediaPaidMedia(
            stars_amount=stars_amount, extended_media=extended_media, payload=payload,
        )
