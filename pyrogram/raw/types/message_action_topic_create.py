...
class MessageActionTopicCreate(TLObject):  # type: ignore
    ...
    __slots__: list[str] = ["icon_color", "icon_emoji_id", "title"]

    ID = 0xD999256
    QUALNAME = "types.MessageActionTopicCreate"

    def __init__(
        self, *, title: str, icon_color: int, icon_emoji_id: int | None = None,
    ) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionTopicCreate":
        ...
        return MessageActionTopicCreate(
            title=title, icon_color=icon_color, icon_emoji_id=icon_emoji_id,
        )
