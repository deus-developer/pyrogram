...
class StarsTransaction(TLObject):  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        extended_media: list["raw.base.MessageMedia"] | None = None,
        subscription_period: int | None = None,
        giveaway_post_id: int | None = None,
        stargift: "raw.base.StarGift" = None,
        floodskip_number: int | None = None,
        starref_commission_permille: int | None = None,
        starref_peer: "raw.base.Peer" = None,
        starref_amount: "raw.base.StarsAmount" = None,
    ) -> None:
        self.id = id  # string
    ...
    def read(b: BytesIO, *args: Any) -> "StarsTransaction":
        ...
        return StarsTransaction(
            ...
            gift=gift,
            reaction=reaction,
            stargift_upgrade=stargift_upgrade,
            title=title,
            ...
            stargift=stargift,
            floodskip_number=floodskip_number,
            starref_commission_permille=starref_commission_permille,
            starref_peer=starref_peer,
