...
from pyrogram.errors import SecurityCheckMismatchError
...
def unpack(
    ...
    SecurityCheckMismatchError.check(
    ...
    data = BytesIO(ige256_decrypt(b.read(), aes_key, aes_iv))
    data.read(8)  # Salt
    ...
    SecurityCheckMismatchError.check(len(payload) % 4 == 0, "len(payload) % 4 == 0")

    # https://core.telegram.org/mtproto/security_guidelines#checking-msg-id
    SecurityCheckMismatchError.check(message.msg_id % 2 != 0, "message.msg_id % 2 != 0")
